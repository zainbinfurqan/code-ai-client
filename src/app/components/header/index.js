...
import bellIcon from '../../../assets/svgs/bell-icon.js';
import BellIcon from '../../../assets/svgs/bell-icon.js';
...
function Header(props) {
    ...
    return (
        ...
        <div class="container flex flex-col flex-wrap items-center p-5 mx-auto md:flex-row">
            ...
            <div class="inline-flex items-center h-full ml-5 lg:w-2/5 lg:justify-end lg:ml-0">
                <div>
                   <BellIcon height={15} width={15}  onClick={()=>setOpenNotification(!openNotification)}/>
                </div>
    ...
    <Notification open={openNotification} onClose={()=>setOpenNotification(!openNotification)}/>
        </div>
    );
}
