...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col  justify-center px-24 py-4">
      <div className='my-3'>
        <h1 className='text-6xl font-mono font-extrabold'>What some fun?</h1>
        <p className='text-base font-mono font-normal my-3'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. </p>
      </div>
